...
module Bundler
  ...
  SPECS        = [
        ...
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/cucumber-0.6.0.gemspec", :name=>"cucumber", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/cucumber-0.6.0/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/data_objects-0.10.1.gemspec", :name=>"data_objects", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/data_objects-0.10.1/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/extlib-0.9.14.gemspec", :name=>"extlib", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/extlib-0.9.14/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/dm-core-0.10.2.gemspec", :name=>"dm-core", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/dm-core-0.10.2/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/dm-aggregates-0.10.2.gemspec", :name=>"dm-aggregates", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/dm-aggregates-0.10.2/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/fastercsv-1.5.3.gemspec", :name=>"fastercsv", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/fastercsv-1.5.3/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/stringex-1.1.0.gemspec", :name=>"stringex", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/stringex-1.1.0/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/uuidtools-2.1.1.gemspec", :name=>"uuidtools", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/uuidtools-2.1.1/lib"]},
        ...
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/mocha-0.9.8.gemspec", :name=>"mocha", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/mocha-0.9.8/lib"]},
        {:loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/nokogiri-1.4.1.gemspec", :name=>"nokogiri", :load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/nokogiri-1.4.1/lib", "/usr/local/lib/ruby/gems/1.8/gems/nokogiri-1.4.1/ext"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/rack-1.1.0.gemspec", :name=>"rack", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/rack-1.1.0/lib"]},
        {:loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/ruby-debug-base-0.10.3.gemspec", :name=>"ruby-debug-base", :load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/ruby-debug-base-0.10.3/lib"]},
        {:loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/ruby-debug-0.10.3.gemspec", :name=>"ruby-debug", :load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/ruby-debug-0.10.3/cli"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/rubyzip-0.9.4.gemspec", :name=>"rubyzip", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/rubyzip-0.9.4/lib"]},
        {:loaded_from=>"/Users/dnutta01/.bundle/ruby/1.8/specifications/sinatra-1.0.gemspec", :name=>"sinatra", :load_paths=>["/Users/dnutta01/.bundle/ruby/1.8/gems/sinatra-1.0/lib"]},
        {:loaded_from=>"/usr/local/lib/ruby/gems/1.8/specifications/sqlite3-ruby-1.2.5.gemspec", :name=>"sqlite3-ruby", :load_paths=>["/usr/local/lib/ruby/gems/1.8/gems/sqlite3-ruby-1.2.5/lib", "/usr/local/lib/ruby/gems/1.8/gems/sqlite3-ruby-1.2.5/ext"]},
      ].map do |hash|
